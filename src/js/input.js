Input = function(){
	this.keys = [game.input.keyboard.addKey(Phaser.Keyboard.LEFT),
...
Input.prototype._createMobileButtons = function(){
...
Input.prototype.desktopUpdate = function(){
	...
	this.dialog = this.keys[4].isDown;
